...
const { basicDataList, filters, pagination, pageSizeOptions, getDefaultAPI, handleGlobalSearch, handleFiltersChange, clearFilter, CurrentChange, SizeChange } = usePaginatedSearchApi(wrappedInventoryListGet, defaultFilters, {
  responseDataToList,
  afterApiCall
});
const getAPI = async () => {
