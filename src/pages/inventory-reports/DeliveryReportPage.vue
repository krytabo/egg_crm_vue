<!-- src/pages/inventory-reports/DeliveryReportPage.vue 司機送貨報表 -->
<script setup>
...
<template>
  <div class="space-y-6 p-6">
    <div>
      <h1 class="text-2xl font-semibold text-gray-900">司機送貨報表</h1>
      <p class="text-sm text-gray-500">管理日報表、列印與轉入訂單</p>
    </div>
    ...
    <DailyShippingReportDialog v-model="createDialogVisible" @report-created="handleReportCreated" />
